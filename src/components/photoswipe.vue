...
<script lang="ts">
    ...
    import { appendOnce, closest, findIndex, get, getImageSize, getSrc, isBgImg, isNum, parseHash, querySelectorList, relevant, setSize } from '../utils'
    ...
    export default class Photoswipe extends Vue {
        ...
        openPhotoSwipe({ index, disableAnimation, fromURL, thumbEls }: OpenArgs) {
