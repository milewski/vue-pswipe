...
// CONCATENATED MODULE: ./src/components/photoswipe.vue?vue&type=template&id=0230ba27&
  ...
  _createClass(Photoswipe, [{
    ...
    value: function parseThumbEls() {
      ...
      return thumbEls.map(function (wrapperEl) {
        ...
        var msrc = get(wrapperEl, 'dataset.pswpMsrc', src);
        return {
          src: src,
          msrc: msrc,
          el: wrapperEl,
...
photoswipevue_type_script_lang_ts_Photoswipe = __decorate([vue_class_component_common_default.a], photoswipevue_type_script_lang_ts_Photoswipe);
